...
class AccordionCustom extends HTMLElement {
  ...
  connectedCallback() {
    ...
    /*
     * Collapse other accordions within the same group
     * Currently scoped to footer menu group
     */
    this.details.addEventListener(
      'toggle',
      () => {
        const parentGroup = this.closest('.ea-footer-menu-group');
        ...
        const accordions = parentGroup.querySelectorAll('accordion-custom');
