...
class DeferredMedia extends Component {
  ...
  connectedCallback() {
    ...
    document.addEventListener(
      ...
      (/** @type {CustomEvent} */ event) => {
        if (event.detail?.resource && event.detail.resource !== this) {
          this.pauseMedia();
        }
      },
      { signal }
  ...
  disconnectedCallback() {
    ...
    if (this._videoElement) {
      if (this._videoPlayHandler) this._videoElement.removeEventListener('play', this._videoPlayHandler);
      if (this._videoPauseHandler) this._videoElement.removeEventListener('pause', this._videoPauseHandler);
      this._videoElement = null;
      this._videoPlayHandler = null;
      this._videoPauseHandler = null;
    }
  }
  ...
  loadContent(focus = true) {
    ...
    if (content instanceof HTMLVideoElement) {
      ...
      content.addEventListener('play', this._videoPlayHandler);
      content.addEventListener('pause', this._videoPauseHandler);
