...
const ZENDESK_HIDE_SOURCE = 'header-drawer';
...
class HeaderDrawer extends Component {
  ...
  #close(details) {
    ...
    // Only restore the launcher when the top-level drawer is closing, not when
    // stepping back out of a submenu (which keeps the main drawer open).
